...
public class MiddleEdge {
     ...
     * follow the correct format for this problem
     */
    private static String middleEdge(int m, int mu, int sigma, String s, String t) {
        // TODO: your code here
        return "";
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(middleEdge(m,mu,sigma,s,t));
    }
}
